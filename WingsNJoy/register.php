...
if ($email_count > 0) {
    ...
    $stmt->bind_param("ssssssssss", $firstName, $lastName, $phoneNumber, $email, $password, $deliveryAddress, $city, $zipCode, $country, $verification_code);
        ...
        $stmt->bind_param("sssssssss", $First_Name,$Last_Name, $phone_number, $email, $password, $delivery_address, $city, $zip_code, $country, $verification_code);
        ...
        if ($stmt->execute()) {
            ...
            if ($stmt_verification->execute()) {
                ...
                echo "Failed to insert email verification details.";
            }
        } else {
